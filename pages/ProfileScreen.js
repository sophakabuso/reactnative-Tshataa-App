    ...
    <View style={styles.container}>
      <View style={styles.topContainer}>
        <View style={styles.imageBox}>
          <Image style={styles.imgContainer} source={{ uri: 'https://media.istockphoto.com/id/177374316/photo/old-lion.jpg?s=612x612&w=0&k=20&c=wzm7ffhggFVh-O5PFtemzatI57lJniP0Xdan_S-wqlw=', }} />
